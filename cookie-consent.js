(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  color: #C9B79C; font-family: inherit; font-size: 0.76rem; line-height: 1.4;',
      '}',
      '#cookie-consent-banner p { margin: 0; flex: 1 1 260px; max-width: 60ch; }',
      '#cookie-consent-banner .cookie-btns { display: flex; gap: 1rem; flex-shrink: 0; }',
      ...
      '  padding: 0.3rem 0.2rem; cursor: pointer; font-size: 0.72rem;',
