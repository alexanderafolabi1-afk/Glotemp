...
if (typeof translations !== 'undefined') {
  const verticalStrings = {
    en: {
      ...
      cities_subtitle: "Live profiles of 150 cities across 12 dimensions.",
      ...
      ranking_note: "Rankings require minimum signal volume to publish.",
      show_details: "Show Details",
      what_is_pulse: "What is Pulse?",
      pulse_explanation: "Pulse measures the emotional temperature of a city right now. It combines human check-ins, sentiment analysis from global news streams (GDELT), and local event signals.",
      pulse_sources: "Data Sources",
      source_user_checkins: "User Check-ins",
    ...
    es: {
      ...
      cities_subtitle: "Perfiles en vivo de 150 ciudades en 12 dimensiones.",
    ...
    fr: {
      ...
      cities_subtitle: "Profils en direct de 150 villes sur 12 dimensions.",
    ...
    de: {
      ...
      cities_subtitle: "Live-Profile von 150 Städten über 12 Dimensionen.",
      vertical_pulse: "Puls",
      vertical_tech: "Tech",
    ...
    pt: {
      ...
      cities_subtitle: "Perfis ao vivo de 150 cidades em 12 dimensões.",
      vertical_pulse: "Pulso",
    ...
    ja: {
      ...
      cities_subtitle: "150都市の12次元のライブプロフィール。",
      vertical_pulse: "パルス",
      vertical_tech: "テック",
