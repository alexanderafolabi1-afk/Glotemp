...
if (typeof translations !== 'undefined') {
  const verticalStrings = {
    en: {
      ...
      cities_subtitle: "Live profiles of 300 cities.",
    ...
    es: {
      ...
      cities_subtitle: "Perfiles en vivo de 300 ciudades en 12 dimensiones.",
    ...
    fr: {
      ...
      cities_subtitle: "Profils en direct de 300 villes sur 12 dimensions.",
    ...
    de: {
      ...
      cities_subtitle: "Live-Profile von 300 Städten über 12 Dimensionen.",
      vertical_pulse: "Puls",
      vertical_tech: "Tech",
    ...
    pt: {
      ...
      cities_subtitle: "Perfis ao vivo de 300 cidades em 12 dimensões.",
      vertical_pulse: "Pulso",
    ...
    ja: {
      ...
      cities_subtitle: "300都市の12次元のライブプロフィール。",
      vertical_pulse: "パルス",
      vertical_tech: "テック",
