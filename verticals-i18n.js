...
if (typeof translations !== 'undefined') {
  const verticalStrings = {
    en: {
      ...
      cities_subtitle: "Live profiles of a growing register of cities.",
    ...
    es: {
      ...
      cities_subtitle: "Perfiles en vivo de un número creciente de ciudades en 12 dimensiones.",
    ...
    fr: {
      ...
      cities_subtitle: "Profils en direct d'un nombre croissant de villes sur 12 dimensions.",
    ...
    de: {
      ...
      cities_subtitle: "Live-Profile einer wachsenden Zahl von Städten über 12 Dimensionen.",
      vertical_pulse: "Puls",
      vertical_tech: "Tech",
    ...
    pt: {
      ...
      cities_subtitle: "Perfis ao vivo de um número crescente de cidades em 12 dimensões.",
      vertical_pulse: "Pulso",
    ...
    ja: {
      ...
      cities_subtitle: "増え続ける都市の12次元のライブプロフィール。",
      vertical_pulse: "パルス",
      vertical_tech: "テック",
