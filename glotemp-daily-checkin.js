  ...
  function renderSignedOut() {
    root.innerHTML = `
      <div class="daily-checkin-card">
        ...
        <p class="daily-checkin-perks-note">Active Voices: consistent contributors to your city's pulse get access to our sponsor rewards, hotel stays, vouchers, partner perks. Check in today to take part.</p>
      </div>`;
