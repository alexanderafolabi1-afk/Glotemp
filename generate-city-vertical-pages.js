...
<head>
  ...
  <link rel="alternate" hreflang="en" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="es" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="fr" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="de" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="pt" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="ja" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
  <link rel="alternate" hreflang="x-default" href="https://glo-temp.com/cities/${city.slug}/${v.slug}/" />
...
` : ''}
  ...
  <script>
    ...
    // the instrument's arc is filled -- purely presentation, never
    // written back. Kept identical to generate-city-pages.js's copy.
    const METRIC_MAX = {
    ...
    // Same circular-instrument language as /explore's city dials and
    // generate-city-pages.js's copy: ivory face, brass ring, coloured
    // reading arc, rim ticks filled by confidence. No hour hand.
    ...
    async function loadVerticalContent() {
      ...
      try {
        ...
        const accentRgb = VERTICAL_ACCENT['${v.slug}'] || '176,141,87';
